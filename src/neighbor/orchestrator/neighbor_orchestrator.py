    ...
    async def screen(
        ...
        *,
        ...
        if cache_coords_match and has_dr and has_vr:
            # First, count profiled neighbors from vr_* files
            neighbors_from_vr = []
            ...
            # Check completeness against regrid_all.json
            ...
            if regrid_file.exists():
                try:
                    ...
                    expected_count = regrid_data.get("total", 0)
                except Exception:
                    pass

            profiled_count = len(neighbors_from_vr)
            completeness_threshold = 0.8  # 80% of expected neighbors must be profiled
